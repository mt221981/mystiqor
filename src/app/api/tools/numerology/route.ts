...
{
  "life_path": "פרשנות עמוקה ואישית של מספר נתיב החיים — 6-8 משפטים. קשר לספירה בעץ החיים, לאות העברית, לכוכב. הסבר מה המספר מגלה על שליחות החיים של ${numbers.name}, אילו אתגרים ואילו מתנות הוא מביא.",
  "destiny": "פרשנות עמוקה ואישית של מספר הגורל — 6-8 משפטים. גלה את הייעוד, הכישרון הנסתר, הדרך שהנשמה בחרה. מה המספר אומר על תכלית החיים.",
  "soul": "פרשנות עמוקה ואישית של מספר הנשמה — 6-8 משפטים. חשוף את הכמיהה הפנימית, מה שמעבר למסכה, הרצון הכמוס שמניע את ${numbers.name} מבפנים.",
  "personality": "פרשנות עמוקה ואישית של מספר האישיות — 6-8 משפטים. איך העולם רואה את ${numbers.name}, מה הוא/היא משדר/ת, הפער בין הפנים לחוץ.",
  "personal_year": "פרשנות עמוקה ואישית של השנה האישית — 6-8 משפטים. מה האנרגיה של השנה הנוכחית, מה כדאי לעשות ומה לשחרר, אילו הזדמנויות ואתגרים השנה מביאה.",
  "synthesis": "פרשנות מאחדת ומקיפה של כל 5 המספרים יחד — 12-15 משפטים עמוקים. חבר את כל החלקים לתמונה שלמה. גלה דפוסים, מתחים פוריים בין המספרים, ומסר מרכזי אחד שהמספרים שולחים ל${numbers.name}. שלב רפרנסים קבליים — ספירות, נתיבות, אותיות. תן המלצות מעשיות ותובנות לחיי היומיום."
}`,
