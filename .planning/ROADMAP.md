...
**Plans**: 3 plans
Plans:
- [ ] 23-01-PLAN.md — Extract shared coach API service + Zustand store + refactor coach/page.tsx imports
- [ ] 23-02-PLAN.md — BottomTabBar (5-tab mobile nav) + tools grid page
...
| 23. Floating Coach & Bottom Tabs | v1.3 | 0/3 | Not started | - |
