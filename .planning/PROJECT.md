...
### Active (v1.5 System Hardening)

- [ ] **STAB-01**: בדיקת מכסת שימוש ומנוי לפני כל קריאת LLM — מניעת חריגה
- [ ] **STAB-02**: timeout + retry עם backoff על קריאות OpenAI
- [ ] **STAB-03**: הודעות שגיאה בעברית למשתמש — לא הודעות גולמיות מ-OpenAI
- [ ] **STAB-04**: ולידציית תגובת LLM עם Zod על כל הכלים
- [ ] **STAB-05**: טיפול בשגיאות DB insert — לא לאבד ניתוחים בשקט
- [ ] **A11Y-01**: תיקון RTL margins (ml/mr → ms/me) בכל הקומפוננטות
- [ ] **A11Y-02**: תיקון ניגודיות צבעים — opacity-40/60 ל-WCAG AA
- [ ] **A11Y-03**: הוספת aria-labels לאלמנטים אינטראקטיביים
- [ ] **UX-01**: empty states לקואצ', מטרות, היסטוריה
- [ ] **UX-02**: טפסים responsive במובייל + הגבלת context של קואצ'

## Current Milestone: v1.5 System Hardening

**Goal:** הפיכת המערכת ליציבה, חסינה ונגישה — שימוש מבוקר, LLM עמיד, UX נגיש
