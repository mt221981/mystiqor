...
## Current Milestone: v1.2 Rich Content & Soul

**Goal:** העברת כל הדאטה העשירה מהמערכת המקורית + הוספת תוכן פנימי שגורם למערכת להרגיש חיה, אישית, וחודרת לנשמה

**Target features:**
- 78 קלפי טארוט מלאים (כולל 40 Minor Arcana) עם קבלה, ארכיטיפים, התאמות אסטרולוגיות
- מילון מזלות עשיר (12 מזלות עם אלמנטים, צבעים, סמלים, תיאורים)
- מילון כוכבי לכת (10 כוכבים עם סמלים, משמעויות, צבעים)
- 12 בתים אסטרולוגיים + 7 אספקטים עם פרשנויות מפורטות
- 4 פריסות טארוט (כולל צלב קלטי)
- בלוג עשיר — 3+ מאמרים מלאים
- מילון רגשות חלומות + תוכן אישי יותר ב-prompts
