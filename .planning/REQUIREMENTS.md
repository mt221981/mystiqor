...
- [x] **COACH-04**: המאמן מקבל הקשר דינמי עדכני בכל הודעה (ניתוחים אחרונים, מצב רוח, יעדים) — לא רק בתחילת שיחה

### ניווט פשוט (Navigation)
- [x] **NAV-01**: במובייל מוצגים 5 טאבים תחתונים (לוח בקרה, מאמן AI, תובנות יומיות, כלים, פרופיל) כניווט ראשי
- [x] **NAV-02**: קטגוריות "אסטרולוגיה מתקדמת" ו"מתקדם" מאוחדות לתוך "כלים מיסטיים" + כפתור "עוד כלים" בסרגל הצד
- [x] **NAV-03**: מצב פתיחת/סגירת קטגוריות בסרגל הצד נשמר ב-localStorage ולא מתאפס בכל טעינה
